...
CREATE OR REPLACE PROCEDURE prc_show_order_by_customer (v_customerID IN VARCHAR) IS
...
END LOOP;
 DBMS_OUTPUT.PUT_LINE(LPAD('=', 100, '='));
 DBMS_OUTPUT.PUT_LINE('Total number of Order made by customer : ' || orderCursor%ROWCOUNT);
...
cl scr
EXEC prc_show_order_by_customer ('C0033')